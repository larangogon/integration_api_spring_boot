...
@Service
public class authenticationMovieDB extends responseBase implements authenticationApi{

    private static final Logger LOG = LoggerFactory.getLogger(authenticationMovieDB.class);
