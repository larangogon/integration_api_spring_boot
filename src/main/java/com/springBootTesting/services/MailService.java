...
import com.springBootTesting.config.MailSenderConfig;
...
public class MailService {
    ...
    private final MailSenderConfig appConfigs;
    ...
    public void sendSimpleMail() {
        ...
        try {
            ...
            File attachmentFile = getFile("classpath:static/attachments/" + propertyConfiuration.PROPERTY_LOGO);
